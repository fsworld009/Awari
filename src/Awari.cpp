...
BEGIN_MESSAGE_MAP(CAwariApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAwariApp::OnAppAbout)
	// 依據文件命令的標準檔案
...
BOOL CAwariApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CAwariDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架視窗
		RUNTIME_CLASS(CAwariView));
	if (!pDocTemplate)
		return FALSE;
